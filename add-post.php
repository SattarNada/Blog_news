...
$status=1;
$posttitle = $con->real_escape_string($posttitle);
$postdetails = $con->real_escape_string($postdetails);
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title" style="color:purple;">Add Post </h4>
...
<div class="form-group m-b-20">
<label for="exampleInputEmail1">Categories of the post</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Post contents </b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b> choose Image</b></h4>
