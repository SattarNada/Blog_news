...
<body>
	...
	<!-- Post Area Start  -->
<?php
if(isset($_GET['searchT'])) $ser = $con->real_escape_string($_GET['searchT']);
...
if (isset($_GET['searchT'])) $sql .= " AND p.PostDetails LIKE '%" . $ser . "%'";
...
if (isset($_GET['searchT'])) $sql = substr_replace($sql, "p.PostDetails LIKE '%" . $ser . "%' OR p.PostTitle LIKE '%" . $ser . "%' AND ", $pos, 0);
			...
			<div class="row justify-content-center">
				...
				<div class="archive-posts-area bg-white p-30 mb-30 box-shadow"> <?php 
					...
					?>
						...
						<div class="single-catagory-post d-flex flex-wrap">
						 <!-- Thumbnail -->
							...
							<div class="post-content">
								...
								<a href="news-details.php?nid=<?php echo htmlentities($row['id'])?>" class="btn-get-started scrollto">Lire la suite &rarr;</a>
								<!-- Post Meta -->
						...
						if ($PdPg > 1) { 
							$pLink = (isset($_GET['searchT'])) ? "?searchT=".$ser."&pg=" : "?pg=" ; ?>
							<!-- Pagination -->
							<nav>
