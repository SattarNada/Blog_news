...
{ 
	...
	if (isset($_GET['action'])) {
		...
		case 'appr':
			$commentId=intval($_GET['cid']);
			$query=mysqli_query($con,"update tblcomments set status=1 where id = '$commentId'");
			if($query)
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
									<h4 class="page-title" style="color:purple;">Manage comments</h4>
									<ol class="breadcrumb p-0 m-0">
										<li>
											<a href="dashboard.php">Admin</a>
										</li>
										<li>
											<a href="unapprove-comment.php">comments</a>
										</li>
										<li class="active">
											Manage comments  
										</li>
...
<?php
$query=mysqli_query($con,"select c.*, p.PostTitle as post from tblcomments as c left join tblposts as p on c.postId = p.id where c.status = 0 order by postingDate Desc");
...
<td>
	<a href="?cid=<?php echo htmlentities($row['id']);?>&&action=appr">
